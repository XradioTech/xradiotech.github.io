...
| 工具 | 版本号 | 说明 | 链接 |
| ---- | ---- | ---- | ---- |
|phoenixMC|v3.1.0330a|工具简介：烧录工具，用于镜像文件的烧录<br><br>更新说明：<br>1、增加打开串口时关闭RTS/DTR的功能<br>2、调试时增加状态信息显示<br><br>参考文档：[《XRADIO_PhoenixMC_Tool_User_Guide-CN》](../../download/4.SDK/document/XRADIO_PhoenixMC_Tool_User_Guide-CN.pdf)|[zip](../../download/4.SDK/tools/xradio_phoenixMC_v3.1.0330a.zip)|
